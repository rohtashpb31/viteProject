    ...
    return (
        <>
            <div className="projects-wrapper pb-0">
                <Container>
                    <div className="text-center client-review-contentBox">
                    <Reveal>    
                    <h2 className="projects-heading mb-2">
                        What Our  <span className="primary-text-color">Clients Say</span>
                    </h2>
                    </Reveal>
                    <Reveal>
                    <p className="text-white pb-3">
                        We take pride in our commitment to quality, reliability, and timely execution. Here's what some of our valued clients have to say about working with Vitel Infratech Pvt. Ltd.
                    </p>
                    </Reveal>
                    </div>
                </Container>
